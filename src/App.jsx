  ...
  return (
    <div className="bg-linear-to-r from-blue-100 to-blue-200">
            ...
            <div className="container mx-auto px-4 py-8">
              <main className="mt-8 md:flex md:gap-8 ">
                <div className="md:w-1/2 flex-1">
                  ...
                  <p className="text-gray-700 mb-24 text-xl ">
                    A free, fast AI tool that checks key areas to help you land
                    more interviews.
                  </p>

                  <div className="border-3 border-dashed border-blue-300 rounded-lg p-8 text-center mb-8 w-1/2 ml-64 mt-40">
      ...
      <div className="partners flex flex-col items-center">
        <h1 className="text-5xl font-semibold mb-7 ">Our partners</h1>
        <div className="w-full flex flex-row justify-around bg-blue-300 py-4">
          <svg
            className="size-20"
