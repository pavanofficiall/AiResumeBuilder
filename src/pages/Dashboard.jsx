                        ...
                        <div className="space-y-2">
                          ...
                          <motion.div
                            whileFocus={{
                              scale: 1.01,
                              boxShadow:
                                "0 0 0 2px rgba(80, 200, 190, 0.3), 0 0 10px rgba(80, 200, 190, 0.2)"
                            }}
                        ...
                        <div className="space-y-6">
                          {resumeData.projects.map(project => (
                            ...
                            >
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                  <Label htmlFor={`proj-title-${project.id}`}>
                                    Project Title
                                  </Label>
                                  <Input
                                ...
                                <div className="space-y-2">
                                  <Label htmlFor={`proj-link-${project.id}`}>
                                    Project Link
                                  </Label>
                                  <Input
